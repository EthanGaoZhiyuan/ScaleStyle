...
class TestLuaAtomicMaterialization:
    ...
    def test_lua_duplicate_returns_duplicate_and_commits(self, consumer_with_mocks, valid_event):
    ...
    def test_lua_exception_returns_failed_and_no_commit(self, consumer_with_mocks, valid_event):
...
class TestCategoryAffinityGuard:
    ...
    def test_unknown_category_passed_to_lua(self, consumer_with_mocks, valid_event):
        ...
        assert call_args[5] == "unknown", "Category should be 'unknown' when lookup fails"
    ...
    def test_valid_category_passed_to_lua(self, consumer_with_mocks, valid_event):
        ...
        call_args = lua_script.call_args.kwargs["args"]
        assert call_args[5] == "dress", "Category should be 'dress' when lookup succeeds"
